...
import {
  ...
  setWaterFile,
  resetWaterUpload,
} from '@/components/store/slices/uploadWaterSlice';
...
const UploadFile: React.FC<FileUploadProps> = ({
  ...
  const { fileName, fileSize, fileType, status, progress, error } = useSelector(
    (state: RootState) => state.uploadWaterFile,
  );
  ...
  return (
    <div className="upload-file">
      ...
      >
        ...
        <div className="title">Water Supply Information</div>
      ...
      {showTemplate && !fileName && (
        <div className="download-template">
          ...
          />
          <div className="text">
            <div className="title">Water supply information Template</div>
            <div className="desc">
