...
import {
  ...
  setSiteFile,
  resetSiteUpload,
} from '@/components/store/slices/uploadSlice';
...
const UploadFile: React.FC<FileUploadProps> = ({
  ...
  const { fileName, fileSize, fileType, progress, status, error } = useSelector(
  ...
  return (
    <div className="upload-file">
      ...
      >
        ...
        <div className="title">Upload Site Surface Information</div>
      ...
      {showTemplate && !fileName && (
        <div className="download-template">
          ...
          />
          <div className="text">
            <div className="title">Site Surface Information Template</div>
            <div className="desc">
